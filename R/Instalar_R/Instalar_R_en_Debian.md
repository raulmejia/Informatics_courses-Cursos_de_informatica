...
2. Si tu sistema es Debian 10 (Buster) Entonces la línea para tu repositorio de R puede verse como:  ```deb http://<favourite-cran-mirror>/bin/linux/debian buster-cran35/```
...
```deb https://cran.itam.mx/bin/linux/debian buster-cran35/```
